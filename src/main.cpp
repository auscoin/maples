...
unsigned int nStakeTargetSpacing = 1 * 60;			// 60 sec block spacing

int64 nChainStartTime = 1378438638;
...
const string strMessageMagic = "maples Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    nSubsidy >>= (nHeight / 1500000); // Approx 1 million blocks per year
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in maples
    bool fStrictPayToScriptHash = true; // Always active in maples
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "maples", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Maples Ay";
        CTransaction txNew;
		...
		txNew.strTxComment = "text: maples genesis block";
   ...
   if (false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x4bf90d378b507e2e01133014b8d40303b3c8d37ef94ab67f23f326dd7bd4755c"));
...
unsigned char pchMessageStart[4] = { 0xe4, 0xe8, 0xef, 0xfd };
